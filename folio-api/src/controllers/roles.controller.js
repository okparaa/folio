...
var roles_schema_1 = require("../schemas/roles.schema");
...
var RolesController = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            RolesController.prototype.createRole = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    var result, newRole, error_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _b.trys.push([0, 3, , 4]);
                                return [4 /*yield*/, (0, validation_util_1.safeParseAsync)(roles_schema_1.NewRolesSchema, req.body, {
                                        abortPipeEarly: true,
                                    })];
                            case 1:
                                result = _b.sent();
                                ...
                                return [4 /*yield*/, this.service.createRole(result.output)];
                            case 2:
                                newRole = _b.sent();
                                //handle role creation failure
                                if (!newRole) {
                                    return [2 /*return*/, res.status(404).json({ message: "Did not return created role" })];
                                }
            ...
            RolesController.prototype.getRoles = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    var query, limit, offset, roles, error_2;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _b.trys.push([0, 2, , 3]);
                                query = (0, validation_util_1.safeParse)(query_schema_1.RequestQuerySchema, req.query, {
                                    abortPipeEarly: true,
                                });
                                // Handle validation issues
                                if (query.issues) {
                                    return [2 /*return*/, res.status(400).json((0, validation_util_1.flatten)(query.issues))];
                                }
                                limit = parseInt(query.output.l);
                                offset = parseInt(query.output.o);
                                return [4 /*yield*/, this.service.getRoles(limit, offset)];
                            case 1:
                                roles = _b.sent();
                            ...
                            case 2:
                                error_2 = _b.sent();
                                return [2 /*return*/, res.status(500).json({
                                        message: error_2 instanceof Error ? error_2.message : "Internal Server Error",
                                    })];
            ...
            RolesController.prototype.updateRole = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    var result, updatedRole, error_3;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _b.trys.push([0, 3, , 4]);
                                return [4 /*yield*/, (0, validation_util_1.safeParseAsync)(roles_schema_1.OldRolesSchema, req.body, {
                                        abortPipeEarly: true,
                                    })];
                            case 1:
                                result = _b.sent();
                                ...
                                return [4 /*yield*/, this.service.updateRole(result.output)];
                            case 2:
                                updatedRole = _b.sent();
                                ...
                                return [2 /*return*/, res.status(200).json(updatedRole)];
                            case 3:
                                error_3 = _b.sent();
                                return [2 /*return*/, res.status(500).json({
            ...
            RolesController.prototype.addRolePermissions = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _b.trys.push([0, 2, , 3]);
                                result = (0, validation_util_1.safeParse)(roles_schema_1.RolesPermitsSchema, __assign(__assign({}, req.body), { id: req.params.id }), { abortPipeEarly: true });
                                //handle validation issues
                                if (result.issues) {
                                    return [2 /*return*/, res.status(400).json((0, validation_util_1.flatten)(result.issues))];
                                }
                                return [4 /*yield*/, this.service.addRolePermissions(result.output)];
                            case 1:
                                response = _b.sent();
            ...
            RolesController.prototype.delRolePermisions = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.service.delRolePermissions(result.output)];
                            case 1:
                                response = _b.sent();
            ...
            RolesController.prototype.getRole = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                if (!id) {
                                    return [2 /*return*/, res.status(400).json({ message: "ID is not specified" })];
                                }
                                return [4 /*yield*/, this.service.getRole(id)];
                            case 1:
                                response = _b.sent();
            ...
            RolesController.prototype.deleteRole = function (req, res) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_b) {
                        //always return forbidden status 403
                        return [2 /*return*/, res.status(403).json({ message: "Role deletion is forbidden" })];
                    });
                });
            };

...
var contents_repository_1 = require("../repository/contents.repository");
...
var ContentsService = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            ContentsService.prototype.createContent = function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, this.repo.create(input)];
                            case 1:
                                response = (_b.sent());
                                if (!response.id) {
                                    return [2 /*return*/, (0, error_utils_1.throwErr)("unable to create product")];
                                }
            ...
            ContentsService.prototype.updateContent = function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, this.repo.update(input)];
                            case 1:
                                response = (_b.sent());
                                if (!response.id) {
                                    return [2 /*return*/, (0, error_utils_1.throwErr)("unable to update product")];
                                }
            ...
            ContentsService.prototype.getContents = function (limit, offset) {
                return __awaiter(this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
            ...
            ContentsService.prototype.getContent = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                response = (_b.sent())[0];
                                if (!response.id) {
                                    return [2 /*return*/, (0, error_utils_1.throwErr)("content does not exist")];
                                }
                                return [2 /*return*/, response];
                        }
                    });
            ...
            ContentsService.prototype.deleteContent = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
        ...
        (function () {
            ...
            _repo_decorators = [(0, injector_1.Inject)(contents_repository_1.ContentsRepository, tables_1.contents)];

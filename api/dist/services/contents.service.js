...
const contents_repository_1 = require("../repository/contents.repository");
...
let ContentsService = (() => {
    ...
    return _a = class ContentsService {
            createContent(input) {
                return __awaiter(this, void 0, void 0, function* () {
                    const response = (yield this.repo.create(input));
                    if (!response.id) {
                        return (0, error_utils_1.throwErr)("unable to create product");
                    }
                    return response;
                });
            }
            updateContent(input) {
                return __awaiter(this, void 0, void 0, function* () {
                    const response = (yield this.repo.update(input));
                    if (!response.id) {
                        return (0, error_utils_1.throwErr)("unable to update product");
                    }
            ...
            getContents(limit, offset) {
                return __awaiter(this, void 0, void 0, function* () {
                    const response = (yield this.repo.find(limit, offset));
                    return response;
                });
            }
            getContent(id) {
                return __awaiter(this, void 0, void 0, function* () {
                    const [response] = (yield this.repo.findOne(id));
                    if (!response.id) {
                        return (0, error_utils_1.throwErr)("content does not exist");
                    }
                    return response;
                });
            }
            deleteContent(id) {
                return __awaiter(this, void 0, void 0, function* () {
                    const response = yield this.repo.delete(id);

...
export type FactoryFunc<T, K extends keyof T, U = T> = keyof T extends K ? (item?: RecPartial<T>) => Promise<U> : (item: RecPartial<T> & Omit<T, K>) => Promise<U>;
export type ListFactoryFunc<T, K extends keyof T, U = T> = keyof T extends K ? (count: number, item?: RecPartial<T>) => Promise<U[]> : (count: number, item: RecPartial<T> & Omit<T, K>) => Promise<U[]>;
